    ...
    */
    ...
    public R save(@RequestBody TuanduiEntity tuandui, HttpServletRequest request){
        ...
        Wrapper<TuanduiEntity> queryWrapper = new EntityWrapper<TuanduiEntity>()
            ...
            .eq("tuandui_zuzhi", tuandui.getTuanduiZuzhi())
            .eq("tuandui_text", tuandui.getTuanduiText())
            ;
...
//            return R.error(511,"永远不会进入");
        ...
        if("".equals(tuandui.getTuanduiFile()) || "null".equals(tuandui.getTuanduiFile())){
                tuandui.setTuanduiFile(null);
        }
        if(tuanduiEntity==null){
...
//                            tuanduiEntity.setTuanduiTypes(Integer.valueOf(data.get(0)));   //团队类型 要改的
//                            tuanduiEntity.setTuanduiPhoto("");//详情和图片
//                            tuanduiEntity.setTuanduiZuzhi(data.get(0));                    //组织结构 要改的
//                            tuanduiEntity.setTuanduiFile(data.get(0));                    //附件 要改的
//                            tuanduiEntity.setTuanduiText(data.get(0));                    //加入我们 要改的
