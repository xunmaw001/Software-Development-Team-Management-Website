...
var indexNav = [
    ...
    {
        name: '线上课程',
        url: './pages/xianshangkecheng/list.html'
    },
    {
        name: '作品集',
        url: './pages/zuopinji/list.html'
    },

]

var adminurl =  "http://localhost:8080/ruanjiankaifatuandui/admin/dist/index.html#/login";
